    ...
    <form action="{{ route('update.barangkeluar', $barangKeluar->id) }}" method="POST">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6">
            <div>
                ...
                <p class="text-muted mb-0">Perbarui informasi barang keluar inventory</p>
            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-icon">
                                ...
                                <input
                                    ...
                                    required
                                    value="{{ old('diambil_oleh', $barangKeluar->diambil_oleh) }}"
                                >
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    flatpickr("#tanggal", {
        dateFormat: "Y-m-d",
        defaultDate: "{{ old('tanggal', $barangKeluar->tanggal) }}",
        locale: {
            firstDayOfWeek: 1,
            weekdays: {
