...
<div class="app-ecommerce">
    <form action="{{ route('store.barangkeluar') }}" method="POST">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6">
            <div>
                <h4 class="mb-1">
                    <i class="ri-logout-box-line me-2" style="color: var(--primary-color);"></i>
                    Tambah Barang Keluar
                </h4>
                <p class="text-muted mb-0">Isi formulir dengan lengkap untuk menambahkan barang keluar dari inventory</p>
            </div>

            <div class="d-flex gap-3">
                <a href="{{ route('index.barangkeluar') }}" class="btn btn-label-secondary">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text">Pilih barang yang akan dikeluarkan dari inventory</small>
                        </div>

                        <!-- Jumlah Keluar -->
                        <div class="mb-4">
                            <label for="jumlah" class="form-label required">Jumlah Keluar</label>
                            ...
                            <small class="form-text">Jumlah unit barang yang keluar (minimal 1 unit)</small>
                        </div>

                        <!-- Diambil Oleh -->
                        <div class="mb-4">
                            <label for="diambil_oleh" class="form-label required">Diambil Oleh</label>
                            <div class="input-icon">
                                <span class="icon-prefix">
                            ...
                            <small class="form-text">Nama orang yang mengambil barang</small>
                        </div>

                        <!-- Tanggal Keluar -->
                        <div class="mb-4">
                            <label for="tanggal" class="form-label required">Tanggal Keluar</label>
                            ...
                            <small class="form-text">Tanggal barang keluar dari inventory</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text">Informasi tambahan tentang barang keluar (opsional)</small>
                        </div>
