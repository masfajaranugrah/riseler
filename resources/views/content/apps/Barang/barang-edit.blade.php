...
<style>
/* ========================================= */
/* MODERN CLEAN UI STYLES 2025 - EDIT FORM */
/* ========================================= */
                ...
                <div class="card mb-6 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text">Jumlah stok barang yang tersedia</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon">
                                <textarea 
                                    ...
                                    name="keterangan" 
                                    rows="4"
                                    placeholder="Tambahkan keterangan atau deskripsi barang (opsional)">{{ old('keterangan', $barang->keterangan) }}</textarea>
