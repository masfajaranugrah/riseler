...
document.addEventListener("DOMContentLoaded", function() {
   ...
   // Event DELETE dengan konfirmasi modern
...
$(document).on('click', '.btn-delete', function(e) {
    ...
    Swal.fire({
        ...
        text: 'Yakin ingin menghapus barang ini? Data tidak dapat dikembalikan!',
        icon: 'warning',
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <div>
                <h4 class="mb-1 fw-bold">
                    <i class="ri-archive-line me-2"></i>Data Barang Inventory
                </h4>
                <p class="mb-0 opacity-75 small">Kelola dan monitor data inventory barang</p>
            </div>
            <div class="d-flex action-buttons mt-3 mt-md-0">
                <a href="{{ route('add-barang') }}" class="btn btn-primary btn-add">
            ...
            <table class="datatables-barang table table-modern table-hover">
                <thead>
                    <tr>
                        ...
                        <th><i class="ri-stack-line me-1"></i>Stok</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-label-primary">{{ $barang->stok }} unit</span>
                        </td>
    ...
    @endif
                        ...
                        <td>
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="{{ route('get-barang', $barang->id) }}" 
