                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select 
                            ...
                            <option value="cash" {{ old('tipe_pembayaran', $expense->tipe_pembayaran ?? '') === 'cash' ? 'selected' : '' }}>Cash</option>
                            <option value="transfer" {{ old('tipe_pembayaran', $expense->tipe_pembayaran ?? '') === 'transfer' ? 'selected' : '' }}>Transfer</option>
                        </select>
                        <small class="form-text-muted">
                            <i class="ri-information-line me-1"></i>Pilih metode pembayaran
                        </small>
