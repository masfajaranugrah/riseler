...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="app-income-add">
        <!-- Page Header -->
        <div class="page-header">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div>
                    <h4>
                        <i class="ri-money-dollar-circle-line me-2"></i>Tambah Pemasukan
                    </h4>
                    <p class="text-muted mb-0">Catat pemasukan keuangan dengan lengkap dan benar</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form id="form-income" action="{{ route('income.store') }}" method="POST">
            @csrf
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea 
                            ...
                            name="keterangan" 
                            rows="4" 
                            placeholder="Tambahkan catatan atau keterangan tambahan mengenai pemasukan ini...">{{ old('keterangan') }}</textarea>
                        <small class="form-text-muted">
