    ...
    <div class="card-header-custom">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div class="d-flex action-buttons mt-3 mt-md-0">
                <a href="{{ route('create.barangmasuk') }}" class="btn btn-primary btn-add">
            ...
            <table class="datatables-barang table table-modern table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-label-primary">{{ $barang->jumlah }} unit</span>
                        </td>
                        
                        <td>
                            <span class="badge badge-status bg-label-info">
                                <i class="ri-checkbox-circle-line me-1"></i>{{ $barang->jenis }}
                            </span>
                        </td>
                        ...
                        <td>
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="{{ route('show.barangmasuk', $barang->id) }}" 
                                   class="btn btn-sm btn-outline-primary"
                                   title="Edit">
                                    <i class="ri-edit-2-line"></i>
                                </a>

                                <form action="{{ route('delete.barangmasuk', $barang->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
