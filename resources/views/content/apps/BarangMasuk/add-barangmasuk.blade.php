...
/* ====================================== */
/* ACTIVE/FOCUS STATE - SEMUA INPUT      */
/* ====================================== */
...
/* Focus State - Untuk Input Number & Text */
...
/* Focus State - Untuk Select (non-Select2) */
...
/* Active State untuk Icon saat Select2 Aktif */
...
/* ====================================== */
/* FLATPICKR ACTIVE STATE                */
/* ====================================== */

/* Active state untuk Flatpickr */
...
<div class="app-ecommerce">
    <form action="{{ route('add.barangmasuk') }}" method="POST">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6">
            <div>
                <h4 class="mb-1">
                    <i class="ri-login-box-line me-2" style="color: var(--primary-color);"></i>
                    Tambah Barang Masuk
                </h4>
                <p class="text-muted mb-0">Isi formulir dengan lengkap untuk menambahkan barang masuk ke inventory</p>
            </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text">Pilih barang yang akan ditambahkan ke inventory</small>
                        </div>

                        <!-- Jumlah -->
                        <div class="mb-4">
                            <label for="jumlah" class="form-label required">Jumlah</label>
                            <div class="input-icon" id="jumlah-icon-wrapper">
                                <span class="icon-prefix">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-icon" id="jenis-icon-wrapper">
                                <span class="icon-prefix">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-icon textarea-wrapper" id="keterangan-icon-wrapper">
                                <span class="icon-prefix">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    flatpickr("#tanggal", {
        ...
        disableMobile: true,
        onOpen: function() {
            // Aktifkan efek biru saat calendar dibuka
            $tanggalIconWrapper.addClass('flatpickr-active');
        },
        onClose: function() {
            // Nonaktifkan efek saat calendar ditutup
            $tanggalIconWrapper.removeClass('flatpickr-active');
        }
    });
    
    // ============================================
    // MANUAL FOCUS HANDLING (Input & Textarea)
    // ============================================
    
    // Input Jumlah
    const jumlahInput = document.getElementById('jumlah');
    const jumlahWrapper = document.getElementById('jumlah-icon-wrapper');
    
    jumlahInput.addEventListener('focus', function() {
        jumlahWrapper.classList.add('input-focused');
    });
    
    jumlahInput.addEventListener('blur', function() {
        jumlahWrapper.classList.remove('input-focused');
    });
    
    // Select Jenis
    const jenisSelect = document.getElementById('jenis');
    const jenisWrapper = document.getElementById('jenis-icon-wrapper');
    
    jenisSelect.addEventListener('focus', function() {
        jenisWrapper.classList.add('input-focused');
    });
    
    jenisSelect.addEventListener('blur', function() {
        jenisWrapper.classList.remove('input-focused');
    });
    
    // Textarea Keterangan
    const keteranganTextarea = document.getElementById('keterangan');
    const keteranganWrapper = document.getElementById('keterangan-icon-wrapper');
    
    keteranganTextarea.addEventListener('focus', function() {
        keteranganWrapper.classList.add('input-focused');
    });
    
    keteranganTextarea.addEventListener('blur', function() {
        keteranganWrapper.classList.remove('input-focused');
    });
