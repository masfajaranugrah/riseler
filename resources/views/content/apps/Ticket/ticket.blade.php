...
<div class="card">
  ...
  <div class="card-header-custom d-flex justify-content-between align-items-start flex-wrap gap-3">
    <div>
      <h4><i class="ri-ticket-2-line me-2"></i>Daftar Ticket</h4>
      <p>Kelola dan monitor tiket gangguan pelanggan</p>
    </div>
    <div class="d-flex align-items-center gap-2 flex-wrap">
      <form action="{{ route('tickets.indexs') }}" method="GET" class="mb-0">
