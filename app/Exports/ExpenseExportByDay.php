...
class ExpenseExportByDay implements WithMultipleSheets
{
    protected $bulan;
    protected $tahun;
    protected $search;
    ...
    public function sheets(): array
    {
        ...
        for ($day = 1; $day <= $daysInMonth; $day++) {
            $sheets[] = new class($day, $this->bulan, $this->tahun, $this->search) extends ExpenseExport implements WithTitle {
                protected $titleDay;
